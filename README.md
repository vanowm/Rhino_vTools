...
- Native commands:
  ...
  - [vSplit](#vsplit-flow) *(26.7.10.1531)* — interactively splits selected curves at picked points with red point preview, cyan remove preview, point snapping, and Undo/Redo
...
1. Click near selected curves to add red split-point markers; point picking is constrained to the chosen curves.
