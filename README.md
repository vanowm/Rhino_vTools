...
1. The packaged `vTools` toolbar includes a `vIsolate` tab with `Isolate A`, `Isolate B`, and `Isolate C` buttons. Left-click isolates into the matching named hide set; right-click shows that set.
